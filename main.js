...
document.getElementById("myCanvas")screen.width==width;

(70 - screen.width)
    document.getElementById("myCanvas")screen.width=new_width;
    document.body.style.overflow="hidden";

(300 - screen.height)
    document.getElementById("myCanvas")screen.height=new_height;
    document.body.style.overflow="hidden";
